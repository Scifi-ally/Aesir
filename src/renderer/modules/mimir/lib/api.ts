import type { IntradayMonitoring } from "@/modules/mimir/types/api";
...
export const api = {
  sessionState: () => apiFetch<import("@/modules/mimir/types/api").SessionState>("/api/system/session-state").then(res => SessionStateSchema.parse(res)),
  systemStatus: () => apiFetch<import("@/modules/mimir/types/api").SystemStatus>("/api/system/status"),
  watchlistToday: () => apiFetch<import("@/modules/mimir/types/api").Watchlist>("/api/watchlist/today"),
  ...
  activeSuggestions: (symbol?: string) => 
    apiFetch<import("@/modules/mimir/types/api").Suggestion[]>(`/api/suggestions/active${symbol ? `?symbol=${encodeURIComponent(symbol)}` : ""}`)
      .then(res => z.array(SuggestionSchema).parse(res)),
  todaySuggestions: () => apiFetch<import("@/modules/mimir/types/api").Suggestion[]>("/api/suggestions/today")
    .then(res => z.array(SuggestionSchema).parse(res)),
  historySuggestions: () => apiFetch<{ data: import("@/modules/mimir/types/api").Suggestion[], total: number }>("/api/suggestions/history?limit=100")
  ...
  dashboardIndices: () =>
    apiFetch<import("@/modules/mimir/types/api").DashboardIndices & { degraded?: boolean; reason?: string }>(
  ...
  marketRegime: () => apiFetch<import("@/modules/mimir/types/api").MarketRegime>("/api/market/regime").then(res => MarketRegimeSchema.parse(res)),
  ...
  scanStatus: () => apiFetch<import("@/modules/mimir/types/api").ScanStatus>("/api/system/offhours-scan"),
  monitoredSymbols: () =>
    apiFetch<{
      symbols: string[];
  ...
  candles: (symbol: string, interval: string, lookbackDays: number, endDate?: string) =>
    apiFetch<{ candles: import("@/modules/mimir/types/api").Candle[] }>(
  ...
  forecast: (symbol: string) => {
    ...
    return apiFetchSoft<import("@/modules/mimir/types/api").SymbolForecast>(
  ...
  symbolInsights: (symbol: string) => {
    ...
    return apiFetchSoft<import("@/modules/mimir/types/api").SymbolInsights>(
  ...
  searchSymbols: (query: string, limit = 12) =>
    apiFetch<{ items: import("@/modules/mimir/types/api").SymbolSearchResult[] }>(
      `/api/system/symbols?q=${encodeURIComponent(query)}&limit=${limit}`,
    ),
  paperTrading: {
    account: () => apiFetch<import("@/modules/mimir/types/api").PaperAccount>("/api/paper/account"),
    positions: () => apiFetch<import("@/modules/mimir/types/api").PaperPosition[]>("/api/paper/positions"),
    history: () => apiFetch<import("@/modules/mimir/types/api").PaperPosition[]>("/api/paper/history"),
  ...
  alertsHistory: () => apiFetch<import("@/modules/mimir/types/api").AlertRecord[]>("/api/alerts/history"),
  ...
  getConfig: () => apiFetch<import("@/modules/mimir/types/api").SystemConfig>("/api/config"),
  updateConfig: (body: import("@/modules/mimir/types/api").UpdateSystemConfig) =>
    apiFetch<import("@/modules/mimir/types/api").SystemConfig>("/api/config", {
      method: "PATCH",
