...
import { Sparkline } from "@/modules/mimir/components/Sparkline";
import { SupportResistancePanel } from "@/modules/mimir/components/SupportResistancePanel";
import { LivePrice } from "@/modules/mimir/components/atoms/LivePrice";
import { LiveChangePct } from "@/modules/mimir/components/atoms/LiveChangePct";
...
import type { Suggestion, SessionState } from "@/modules/mimir/types/api";
import { SPRING_STANDARD } from "@/modules/mimir/lib/motion";
...
export const DetailPanel = React.memo(function DetailPanel({ suggestions, selectedSymbol, session, isScanActive, isAuthenticated }: DetailPanelProps) {
  ...
  const insightsQuery = useQuery({
    ...
    enabled: Boolean(selectedSymbol && typeof selectedSymbol === "string" && selectedSymbol.trim() && isAuthenticated),
    retry: false,
